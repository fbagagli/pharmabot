...
def step_3b_load_all_results(sb):
    ...
    while clicks < max_clicks:
        try:
            ...
            if sb.is_element_visible(load_more_btn):
                console.print(f"[grey50]Found 'Load More' button (Click {clicks+1})...[/]")
                ...
                console.print("[green]✔ No more 'Load More' buttons found. List is complete.[/]")
                break
    ...
    if clicks == max_clicks:
        console.print("[yellow]⚠ Reached max click limit. Proceeding with current data.[/]")
