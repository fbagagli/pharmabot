...
def test_single_pharmacy_optimization(session: Session):
    # Setup
    p1 = Pharmacy(name="P1", base_shipping_cost=Decimal("5.00"), free_shipping_threshold=Decimal("50.00"))
    session.add(p1)
...
def test_multi_pharmacy_optimization(session: Session):
    ...
    p1 = Pharmacy(name="P1", base_shipping_cost=Decimal("5.00"), free_shipping_threshold=Decimal("100.00"))

    # P2: Item A ($5). Shipping $5. Free > $4. (So Free). Total $5.
    p2 = Pharmacy(name="P2", base_shipping_cost=Decimal("5.00"), free_shipping_threshold=Decimal("4.00"))

    # P3: Item B ($5). Shipping $5. Free > $4. (So Free). Total $5.
    p3 = Pharmacy(name="P3", base_shipping_cost=Decimal("5.00"), free_shipping_threshold=Decimal("4.00"))
...
def test_shipping_threshold_sensitivity(session: Session):
    ...
    p1 = Pharmacy(name="P1", base_shipping_cost=Decimal("10.00"), free_shipping_threshold=Decimal("15.00"))

    # P2: Item A ($8). Shipping $10. Total $18.
    p2 = Pharmacy(name="P2", base_shipping_cost=Decimal("10.00"), free_shipping_threshold=None)

    # P3: Item B ($8). Shipping $10. Total $18.
    p3 = Pharmacy(name="P3", base_shipping_cost=Decimal("10.00"), free_shipping_threshold=None)
